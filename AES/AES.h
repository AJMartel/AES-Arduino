  ...
  */
  void set_IV_array(byte *ivc1);
	...
	*/
	 ...
	 */
	void padPlaintext(byte* in,byte* out);
    void unpadPlaintext(byte* in);
	...
	*/
	 ...
	 * @note The key will be stored in class variable.
	 */
	void do_aes_encrypt(byte *plain,int size_p,byte *cipher);
	 ...
	 * @note The key will be stored in class variable.
	 */
	void do_aes_decrypt(byte *cipher,int size_c,byte *plain);
